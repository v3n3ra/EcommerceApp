        ...
        if vm.latestResponse != nil {
            ZStack(alignment: .top) {
                Rectangle()
                    ...
                    .frame(height: UIConstants.height/6)
                    .cornerRadius(30)
                ...
                HStack {
                            ...
                            Button {
                                ...
                                ZStack {
                                    Rectangle()
                                        ...
                                        .frame(width: UIConstants.width/9, height: UIConstants.width/15)
                                        .cornerRadius(9)
                    ...
                    ZStack {
                        Rectangle()
                            .foregroundColor(Color("customBlue"))
                            .frame(width: UIConstants.width/2, height: UIConstants.width/8)
                            .cornerRadius(19)
