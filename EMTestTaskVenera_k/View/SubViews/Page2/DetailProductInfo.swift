        ...
        if vm.detailResponse != nil {
            VStack {
                ...
                Text(vm.detailResponse!.description)
                    ...
                    .frame(width: Helpers.width/1.8, height: 40)
                    ...
                    HStack {
                        ForEach(vm.detailResponse!.colors, id: \.self) { color in
                            Button {
                                ...
                                ZStack {
                                    Rectangle()
                                        .frame(width: Helpers.width/11, height: Helpers.width/14)
                                        .cornerRadius(9)
                                        .padding(.trailing, 5)
                                        .foregroundColor(.gray)
                                    
                                    Rectangle()
                                        .frame(width: Helpers.width/12, height: Helpers.width/15)
                                        .cornerRadius(8)
                                        .padding(.trailing, 5)
